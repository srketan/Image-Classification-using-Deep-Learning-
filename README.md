•	Performed Image Classification using neural network models on MNIST and CIFAR 10 datasets to understand the fundamental concepts of convolutional neural networks (CNN).
